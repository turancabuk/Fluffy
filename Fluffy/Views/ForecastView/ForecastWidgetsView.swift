                        ...
                        VStack(alignment: .leading) {
                            ...
                            HStack(spacing: 14) {
                                VStack(alignment: .leading, spacing: 12) {
                                    Text("Wind Speed: \(String(format: "%.2f", windSpeed ?? 0)) km/h")
                                    Divider()
                                        .background(Color.gray)
                                    Text("Wind Gust: \(String(format: "%.2f", windGust ?? 0)) km/h")
                                    Divider()
                                        .background(Color.gray)
                                    Text("Wind Degree: \(windDeg ?? 0)")
                                }
                                Spacer()
                                ZStack {
                                    // Dış çember
                            ...
                            HStack(spacing: 32) {
                                VStack(alignment: .leading) {
                                    HStack(spacing: 12) {
                                        ...
                                        Text(moonrise.map {timeFormatter.string(from: $0)} ?? "HH:mm")
                                    }
                                    Divider()
                                        .background(Color.gray)
                                    HStack(spacing: 12) {
                                        Image(systemName: "moonset.fill")
                                        Text(moonset.map {timeFormatter.string(from: $0)} ?? "HH:mm")
                                    }
                                    Divider()
                                        .background(Color.gray)
                                    HStack(spacing: 12) {
                                        Image(systemName: "moon.road.lanes")
                                        Text("\(String(format: "%.2f", moonphase ?? 0.0))")
                                    }
                                }
                                .frame(maxWidth: .infinity, alignment: .leading)
                                Spacer()
